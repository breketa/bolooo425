    ...
    return (
      <div className={`flex mb-4 ${isOwn ? 'justify-end' : 'justify-start'}`}>
        ...
        <div className={`rounded-lg py-2 px-3 ${
          ...
          <div className={`text-xs mt-1 text-right ${isOwn ? 'text-indigo-100' : message.isAdmin ? 'text-gray-300' : message.isSystem ? 'text-yellow-500' : 'text-gray-400'}`}>
...
console.log("ChatInterface component rendered");  if ((isRealSellerForPayment || user?.isAdmin) && (chatData?.status === "awaiting_seller_confirmation" || 
  ...
  return (
    <div className="flex flex-col w-full h-full overflow-hidden">
      ...
      {/* Message Input */}
      <form onSubmit={handleSendMessage} className="bg-[#212121] p-4 border-t border-gray-800">
        <div className="flex items-center gap-2">
          <div className="flex-1 flex items-center gap-2 px-4 py-2 border border-gray-700 rounded-full bg-[#212121] hover:bg-gray-800 focus-within:bg-gray-800 focus-within:border-gray-600 focus-within:ring-2 focus-within:ring-gray-700 transition-all duration-200 shadow-sm">
            <div className="relative emoji-picker-container">
              <button type="button" className="text-gray-400 hover:text-gray-300 transition-colors emoji-picker-trigger" title="Add emoji">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
            ...
            <input 
              ...
              className="flex-1 bg-transparent border-none outline-none placeholder-gray-500 text-gray-200" 
              type="text" 
              value={newMessage}
          ...
          <button 
            type="submit" 
            className="p-3 bg-[#212121] hover:bg-gray-800 text-gray-200 rounded-full hover:shadow-md disabled:opacity-50 transition-all duration-200 flex items-center justify-center border border-gray-700" 
            title="Send message" 
